...
qtCreatorFile = "Proyecto_P10_Encuentra_el_Numero.ui" # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.diccionarioImagenes[1] = "ClicImagenes/uno.png"
        self.diccionarioImagenes[2] = "ClicImagenes/dos.png"
        self.diccionarioImagenes[3] = "ClicImagenes/tres.png"
        self.diccionarioImagenes[4] = "ClicImagenes/cuatro.png"
        self.diccionarioImagenes[5] = "ClicImagenes/cinco.png"
        ...
        self.diccionarioPreguntas[0] = ["Numero 1", 1, array1]   #pregunta 0
        self.diccionarioPreguntas[1] = ["Numero 2", 2, array2]   #pregunta 1
        self.diccionarioPreguntas[2] = ["Numero 3", 3, array3]   #
        self.diccionarioPreguntas[3] = ["Numero 4", 4, array4]   #
        self.diccionarioPreguntas[4] = ["Numero 5", 5, array5]   #pregunta 4
